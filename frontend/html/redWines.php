...
<head>
    ...
    <title>Red Wines | Wine Exchange</title>
        ...
        <div class="wines-list">
            ...
            <div class="wine">
                ...
                <div class="information">
                    ...
                    <div class="buttons">
                        <a href="wineinfo.php?id=1"><button class="winebutton">SEE MORE INFO</button></a>
                        <a href="redWines.php?add=1"><button class="winebutton">ADD TO BASKET</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="wine">
                ...
                <div class="information">
                    ...
                    <div class="buttons">
                        <a href="wineinfo.php?id=2"><button class="winebutton">SEE MORE INFO</button></a>
                        <a href="redWines.php?add=2"><button class="winebutton">ADD TO BASKET</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="wine">
                ...
                <div class="information">
                    ...
                    <div class="buttons">
                        <a href="wineinfo.php?id=3"><button class="winebutton">SEE MORE INFO</button></a>
                        <a href="redWines.php?add=3"><button class="winebutton">ADD TO BASKET</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="wine">
                ...
                <div class="information">
                    ...
                    <div class="buttons">
                        <a href="wineinfo.php?id=4"><button class="winebutton">SEE MORE INFO</button></a>
                        <a href="redWines.php?add=4"><button class="winebutton">ADD TO BASKET</button></a>
                    </div>
                </div>
            </div>
        </div>
