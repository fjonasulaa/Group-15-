...
$msg = ""; // feedback message for basket stuff

// make sure we actually have a wine ID
if (!isset($_GET['id'])) {
...
// TODO: maybe paginate this if reviews get long
    ...
    <div class="info-card">
        ...
        <div class="content">
            ...
            <div class="price">
                ...
                <!-- clicking stars jumps down to reviews -->
            ...
            <!-- ingredients hover card - looks cool -->
            <div class="container">
...
<script>
    // is the user logged in? used throughout for wishlist logic
...
<div class="reviews-container">
    ...
    <div class="reviews-top-bar">
        <!-- passes wineId through so the review form knows what we're reviewing -->
...
<!-- subtle 3D tilt on review cards -->
<script>
...
// guest wishlist lives in localStorage
...
function renderWishlist(list) {
    ...
    list.forEach((wine, idx) => {
        ...
        // image path differs slightly between logged-in and guest
        let img;
        if (loggedIn) {
...
// check if current wine is already wishlisted and update button state
