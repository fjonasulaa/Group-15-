...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .footer-newsletter .newsletter-form input:focus { border-color: rgba(255,255,255,.5); }
    .footer-newsletter .btn-subscribe {
      padding: 7px 16px; border-radius: 8px;
      background: #fff; border: none;
      color: #6b1a2e; font-size: 15px; font-weight: 500;
    ...
    .payment-icon {
      background: #6b1a2e; color: #f5e6c8;
    ...
    .age-badge {
      background: #fdf0e8; border: 0.5px solid #c9a84c;
